...
import { ITicket, INewTicket, ITicketPaginated } from '../interfaces/Ticket.interface';
...
export class TicketService {
	...
	// TODO fix type
	addTicket(ticket: INewTicket): Observable<INewTicket>{
		const url = `${this.urlHost}/${this.apiEndPoint}`;
		// TODO request body
		return this.http.post<INewTicket>(url, {description: ticket.description}, httpOptions);
	}
